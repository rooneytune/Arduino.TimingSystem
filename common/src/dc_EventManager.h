...
#ifndef dc_EventManager_h
#define _dc_EventManager_h
...
public:
    ...
    enum EventType
    {
        ...
        //Events generated by web server
        kEventWebServer_toggleRecordMode,
        kEventWebServer_clearRssiScanResultSet,
        kEventWebServer_sendRssiSettingsToClient
    };
